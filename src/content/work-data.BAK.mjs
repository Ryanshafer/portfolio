...
*   **Speed Transformation:** Reduced test results delivery time from days to seconds.
...
*   **Cross-Team Influence:** Championed UX priorities across product, engineering, marketing, and science teams.`,
  },
  {
    ...
    location: 'Italy',
    intro:
      'During the pandemic, I balanced family responsibilities—homeschooling my children—while recovering from health challenges and pursuing selective freelance design work to stay close to the field.',
    description: `### Key Achievements
*  Delivered small UX and product strategy projects for international clients.
*  Explored emerging tools and workflows in design systems, and front-end prototyping.
*  Partnered with Oritain on early design consulting, which evolved into a full-time leadership role.`,
  },
  {
    title: 'Head of User Experience Design (UX Lead)',
    company: 'Showmax',
...
*   **Legacy Leadership:** One designer I hired later took over as lead UX after my departure and continued leading the discipline for years—validating the quality and long-term impact of the hiring decision.`,
  },
  {
    ...
    location: 'Italy',
    intro:
      'After several high-intensity years leading UX at MTV, I relocated with my family to Europe and took time to recharge, raise young children, and reestablish creative balance. During this period, I stayed active in design through independent projects and industry engagement, including speaking at a UX event in Copenhagen.',
    description: `### Key Achievements
*  Continued hands-on design and research exploration across digital and physical design.
*  Refined leadership perspective through reflection on organizational culture and sustainable design practices which formed the foundation of a talk I delivered in Copenhagen.
*  Returned to full-time work reenergized, joining Showmax to build their first in-house UX team.`,
  },
  {
