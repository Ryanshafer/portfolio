...
summary:
  ...
  impact: "Achieved 100% task completion in testing, reduced data entry errors and duplicates entering the system, and unlocked a scalable new revenue stream—helping secure one of Oritain’s largest client contracts to date."
...
<ImageWithStyle src="/assets/studies/ui-design-complex-workflows/content/oritain-manual-flow.webp" alt="Mapping Oritain’s manual testing process revealed a fragmented, error-prone workflow — critical context for our UI design decisions." />
...
<ImageWithStyle src="/assets/studies/ui-design-complex-workflows/content/oritain-cards.webp" alt="Key entities—Contracts, Facilities, and Tests—were modeled as interactive cards. This modular structure reduced cognitive load and enabled scalable, reusable UI patterns." />
...
<ImageWithStyle src="/assets/studies/ui-design-complex-workflows/content/oritain-digital-flow.webp" alt="The digital flow preserved core steps but streamlined responsibilities between suppliers and Oritain." />
...
<ImageWithStyle src="/assets/studies/ui-design-complex-workflows/content/oritain-payment.webp" alt="Instead of building everything from scratch, we used Stripe for payments and DocuSign for contract signing." />
...
<ImageWithStyle src="/assets/studies/ui-design-complex-workflows/content/oritain-error-states.webp" alt="Error states were surfaced through clear messages and interface cues to prevent wasted tests — critical for supplier trust." />
...
<ImageWithStyle src="/assets/studies/ui-design-complex-workflows/content/oritain-responsive.webp" alt="Designed for fluid layouts and touch support for a range of devices—factory-floor tablets and office desktop computers" />
...
<ImageWithStyle src="/assets/studies/ui-design-complex-workflows/content/oritain-user-testing.webp" alt="During usability testing, some users had trouble completing tasks because instructions were unclear or important information was missing." />
